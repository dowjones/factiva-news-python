...
def test_get_identifiers_for_category():
    ...
    assert industry_codes[industry_codes['code'] == 'i25121'] is not None


def test_request_data_for_company():
    taxonomy = Taxonomy()
    company_data = taxonomy.get_company('isin', company_code='PLUNMST00014')
...
def test_request_data_for_multiple_companies():
    ...
    companies_data = taxonomy.get_company('isin', companies_codes=companies)
